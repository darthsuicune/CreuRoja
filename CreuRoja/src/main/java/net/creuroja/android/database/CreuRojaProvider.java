...
public class CreuRojaProvider extends ContentProvider {
    protected static final String CONTENT_NAME = "net.creuroja.android.database.CreuRojaProvider";
    ...
    static {
        ...
        sUriMatcher.addURI(CONTENT_NAME, CreuRojaContract.Locations.TABLE_NAME + "/#", LOCATIONS_ID);
    }
    ...
    public String getType(Uri uri) {
        switch (sUriMatcher.match(uri)) {
            case LOCATIONS:
                return ContentResolver.CURSOR_DIR_BASE_TYPE + CONTENT_NAME + "." + CreuRojaContract.Locations.TABLE_NAME;
            case LOCATIONS_ID:
                return ContentResolver.CURSOR_ITEM_BASE_TYPE + CONTENT_NAME + "." + CreuRojaContract.Locations.TABLE_NAME;
            default:
                return null;
        }
    }
