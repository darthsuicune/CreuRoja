...
public class CRMapFragment extends Fragment implements GoogleMap.OnInfoWindowClickListener,
    ...
    private void setCheckBoxVisibility(int checkBoxResId, int boxResId, String showTag) {
        ...
        CheckBox checkBox = (CheckBox) mMarkerPanel.findViewById(checkBoxResId);
        View box = mMarkerPanel.findViewById(boxResId);
        checkBox.setChecked(prefs.getBoolean(showTag, true));
        checkBox.setOnCheckedChangeListener(this);
        box.setVisibility(mUser.canSeeCheckBox(boxResId));
    }
