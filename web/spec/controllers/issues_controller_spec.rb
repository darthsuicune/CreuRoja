...
RSpec.describe IssuesController, :type => :controller do
	...
	let(:valid_attributes) {
		{:status => "new", :severity => "normal", :short_description => "asdf", :long_description => "asdfasdf"}
	}

	let(:invalid_attributes) {
		{:short_description => "asdf" * 16}
	}
	...
	describe "PUT update" do
		describe "with valid params" do
			let(:new_attributes) {
				{:status => "In work", :severity => "low", :short_description => "asdf", :long_description => "asdfasdf"}
			}
			...
			it "updates the requested issue" do
				...
				issue.reload
				expect(issue.status).to eq("In work")
			end
